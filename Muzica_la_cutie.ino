...
void loop()
{
  ...
  else if ((sensorreading > threshold)&& !(digitalRead(buttonSong) == ACTIVATED)) { // if dark, pause
    flag = true;
  }
  ...
  if( (flag == true) && (flag2 == true)){
       for (int thisNote=0; thisNote <85; thisNote++) {
          ...
          noTone(11);
          sensorreading = analogRead(photo_sensor);
          if((sensorreading < threshold) || (digitalRead(buttonSong) == ACTIVATED))
          break;
